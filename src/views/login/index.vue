<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-button :loading="loading" class="login_btn" type="primary" style="width: 100%; margin-bottom: 30px" @click.native.prevent="handleLogin">登录</el-button>
  ...
  data() {
    ...
    return {
      ...
      loginRules: {
        ...
        password: [{ required: true, trigger: 'blur', min: 6, max: 16, message: '请输入6-16位密码' }]
      },
      loading: false,
